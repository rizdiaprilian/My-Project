...
from postgres_con import connect, postgresql_to_dataframe
...
def main():
    ...
    precision, recall, fscore, accuracy, tnr, npv, fpr, tpr, auc, y_prob, conf_matrix_array = classification(classifier, X_train, y_train, X_test, y_test)
